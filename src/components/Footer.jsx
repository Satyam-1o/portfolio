export default function Footer() {
  return (
    <>
      <footer
        id="contact"
        className="w-full flex items-center pt-6 border-t border-[#A8ADB2]/20 pb-1 mt-20"
      >
        <div className="flex items-center gap-2 text-[#A8ADB2] hover:text-white">
          <svg
          ...
          <a href="mailto:satyam312004@gmail.com">
            satyam312004@gmail.com
          </a>
        </div>
      </footer>
    </>
