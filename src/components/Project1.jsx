    ...
    <div className="flex flex-col w-full">
      <div className="flex items-start gap-8">
        <div className="rounded-lg w-[640px] border border-[#A8ADB2]/50 p-5 flex flex-col gap-5">
          <a aria-label="See more about the EduQuest App" href="/eduquest">
            <img
              alt="project-screenshot"
              loading="lazy"
              width="600"
              class="rounded-md object-cover"
              src="/images/eduquest/edu-quest-cover.png"
            />
          </a>
          <div className="flex flex-col">
            ...
            <p className="text-[#A8ADB2] mt-3">
              <span className="text-white">EduQuest</span> is a platform where you gamify your
              environmental learning journey with interactive lessons, projects,
